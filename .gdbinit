...
define eflags
    if $ARM == 1
        ...
        printf "     N <%d>  Z <%d>  C <%d>  V <%d>",\
               (($xpsr >> 0x1f) & 1), (($xpsr >> 0x1e) & 1), \
               (($xpsr >> 0x1d) & 1), (($xpsr >> 0x1c) & 1)
        printf "  Q <%d>  J <%d>  GE <%d>  E <%d>  A <%d>",\
               (($xpsr >> 0x1b) & 1), (($xpsr >> 0x18) & 1),\
               (($xpsr >> 0x10) & 7), (($xpsr >> 9) & 1), (($xpsr >> 8) & 1)
        printf "  I <%d>  F <%d>  T <%d> \n",\
               (($xpsr >> 7) & 1), (($xpsr >> 6) & 1), \
               (($xpsr >> 5) & 1)
     else

...
"  syn match doxygenSpecialContinueComment contained +^\s*\*/\@!\s*+ nextgroup=doxygenSpecial skipwhite
  ...
  try
    ...
    SynLink doxygenLeadingLWhite           DoxygenCommonX
    ...
    SynLink doxygenCommentWhite            DoxygenCommonX
    SynLink doxygenCommentWhite2           DoxygenCommonX
    SynLink doxygenContinueCommentWhite    DoxygenCommonX
    SynLink doxygenStartSkipWhite          DoxygenCommonX
